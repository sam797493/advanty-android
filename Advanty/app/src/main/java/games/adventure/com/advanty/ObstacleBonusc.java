...
public class ObstacleBonusc extends Obstacle {
	...
	public ObstacleBonusc(float _x, float _y, float _z, float _width, float _height, char type){
		...
		bonusScoreEffectImg = Util.loadBitmapFromAssets("game_bonusscore3.png");
