...
public class Menud extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		gameIntent = new Intent (this, maind.class);
		mPlayButton = (android.widget.Button)findViewById(R.id.startButton4);
