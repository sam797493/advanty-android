...
public class ObstacleBonusd extends Obstacle {
	...
	public ObstacleBonusd(float _x, float _y, float _z, float _width, float _height, char type){
		...
		bonusScoreEffectImg = Util.loadBitmapFromAssets("game_bonusscore4.png");
