...
//			initialize();
		...
		private void initialize() {
			...
			try {
				...
				background.loadLayerFar(Util.loadBitmapFromAssets("game_background_layer_2.png"));
				sleep();
				...
				try {
					...
					background.loadLayerFar(
							Util.loadBitmapFromAssets("game_background_layer_2.png"));
					sleep();
			...
			player = new Playerb(getApplicationContext(), mRenderer, height);
			sleep();

			level = new Levelb(context, mRenderer, width, height);
			sleep();
