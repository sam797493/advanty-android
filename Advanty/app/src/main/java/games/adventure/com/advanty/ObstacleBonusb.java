...
public class ObstacleBonusb extends Obstacle {
	...
	public ObstacleBonusb(float _x, float _y, float _z, float _width, float _height, char type){
		...
		bonusScoreEffectImg = Util.loadBitmapFromAssets("game_bonusscore2.png");
